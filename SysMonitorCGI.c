...
int main(int argc, char *argv[]){
	...
	{ // Escopo para a criação da variavel temporária "cnt"
	  int cnt;
	...
	{ // Escopo para a contencao destas variaveis temporarias
	...
	//------------------- Extração dos dados de uso de CPU ----------------------------------- 
	...
	{ // Escopo para isolar variáveis temporárias
	...
	//------------------------- Extração de dados da memoria RAM -------------------------------
	...
	//------------------------ Extração de dados de armazenamento ------------------------------
	...
	return -99;
	*/
	//-------------------- Extração de dados e dispositivos de rede ----------------------------
